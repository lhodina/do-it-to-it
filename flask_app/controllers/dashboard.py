...
def go_to_dashboard():
    if session and session["current_user"]:
        ...
        return render_template("dashboard.html", all_user_priorities=all_user_priorities, all_categories=all_categories, all_tags=all_tags, all_user_links=all_user_links)
    else:
        return redirect("/")
